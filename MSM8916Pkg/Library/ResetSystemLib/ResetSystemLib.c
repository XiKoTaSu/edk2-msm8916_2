...
STATIC VOID shutdown_device(VOID)
{
  ...
  /* PM8916: S2_RESET_EN PON_PS_HOLD_RESET_CTL2'de -> CTL2 tabanli pm8x41_reset_configure
     dogru varyant. v2 (CTL tabanli) PM8916'da reset/shutdown'i ENABLE etmiyordu. */
...
STATIC VOID reboot_device(UINTN reboot_reason)
{
  ...
  mPm8x41->pm8x41_reset_configure(reset_type);
