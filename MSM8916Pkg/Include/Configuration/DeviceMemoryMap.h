...
static ARM_MEMORY_REGION_DESCRIPTOR_EX gDeviceMemoryDescriptorEx[] = {
    ...
    // DB410c: Bu kucuk RtData (EfiRuntimeServicesData) carve-out'lari 64KB hizali
    // OLMAYAN adreslerdeydi (0x80385000, 0x80386000) -> arm64 ExitBootServices
    // "RUNTIME memory entry is not on a proper alignment" -> Linux EFI-stub reddediyordu.
    // WP artigi; DB410c'de gereksiz. RtData -> BsData (runtime gereksinimi kalkar).
    {"FBPT Payload", 0x80380000, 0x00001000,      AddMem, SYS_MEM, SYS_MEM_CAP, BsData, UNCACHED_UNBUFFERED},
    {"DBG2", 0x80381000, 0x00004000,              AddMem, SYS_MEM, SYS_MEM_CAP, LdData, UNCACHED_UNBUFFERED},
    {"Capsule Header", 0x80385000, 0x00001000,     AddMem, SYS_MEM, SYS_MEM_CAP, BsData, UNCACHED_UNBUFFERED},
    {"TPM Control Area", 0x80386000, 0x00003000,  AddMem, SYS_MEM, SYS_MEM_CAP, BsData, UNCACHED_UNBUFFERED},
...
//{ "HLOS 3",  0x80D00000, 0x03300000,          AddMem, SYS_MEM, SYS_MEM_CAP, BsData, WRITE_BACK},
    ...
    /* RAM partition regions - DB410c: 1GB RAM = 0x80000000-0xBFFFFFFF.
       Eskisi 0xc0000000-0xf0000000 VAR OLMAYAN RAM tanimliyordu ve
       0xb0000000-0xc0000000 MAP EDILMEMIS bosluk kaliyordu; stack/sayfa-tablosu
       (~0xBFxxxxxx) o bosluga dustugu icin MMU acilinca DONUYORDU.
       Simdi 0x8e800000-0xC0000000 KESINTISIZ, otesi (var olmayan RAM) YOK. */
    {"RAM Partition",     0x8cb00000, 0x01500000, AddMem, SYS_MEM, SYS_MEM_CAP,  Conv,   WRITE_BACK_XN},
    /* 0x8e800000 - 0xC0000000 (kesintisiz; stack ve UEFI mem/sayfa tablolari burada) */
    {"RAM Partition",     0x8e800000, 0x31800000, AddMem, SYS_MEM, SYS_MEM_CAP,  Conv,   WRITE_BACK_XN},
