...
CHAR8 *mSysInfoType1Strings[] = {
    "Qualcomm", "DragonBoard 410c", "DragonBoard 410c", "Unknown",
    "DragonBoard 410c",          "SBC",        NULL};
...
CHAR8 *mBoardInfoType2Strings[] = {
    "Qualcomm", "DragonBoard 410c", "DragonBoard 410c", "Unknown", "", "", NULL};
...
CHAR8 *mEnclosureInfoType3Strings[] = {"DragonBoard 410c", "1", "Unknown", "",
                                       NULL};
...
VOID MemArrMapInfoUpdateSmbiosType19(VOID)
{
  ...
  mMemArrMapInfoType19.EndingAddress =
      (UINT32)((FixedPcdGet64(PcdSystemMemorySize) + FixedPcdGet64(PcdSystemMemoryBase) -
       1) / 1024);
